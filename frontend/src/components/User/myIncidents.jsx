...
export default function MyIncidents() {
  ...
  const fetchTickets = async () => {
    try {
      // Member 4 fix: use /my endpoint to get only logged in user's tickets
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                <div className="bg-gray-50 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                  <AlertCircle className="text-gray-400" size={30} />
                </div>
                <h3 className="text-gray-900 font-medium">No tickets found</h3>
                <p className="text-gray-500 text-sm mt-1">You haven't raised any tickets yet.</p>
              </div>
            ) : (
