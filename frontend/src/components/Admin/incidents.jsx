  ...
  return (
    <main className="p-8">
      <div className="mb-8 flex justify-between items-center">
        ...
        <Link to="/incidents/create" className="bg-indigo-600 text-white px-4 py-2.5 rounded-xl flex items-center gap-2 hover:bg-indigo-700 transition-colors shadow-sm">
          <Plus size={18} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
          <div className="flex justify-between items-start mb-4">
            <span className="text-gray-500 text-sm font-medium">Total Tickets</span>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
          ...
          <p className="text-xs text-blue-600 font-medium">Awaiting action</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
          ...
          <p className="text-xs text-yellow-600 font-medium">Being worked on</p>
        </div>
            ...
            >
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-blue-600 font-semibold text-sm">{ticket.id}</span>
              ...
              <Link to={`/incidents/${ticket.id}`} className="mt-4 md:mt-0 text-indigo-600 hover:text-indigo-800 text-sm font-medium flex items-center gap-1">
                <Eye size={16} />
                View Details
              </Link>
            </div>
